...
--18)
/*
 Il y a Ambiguité Car  si 1 autre bateau d'1 competition donnée
 arrive premier et qu'il y a déjà 1 bateau classé premier 
 qui est le Vrai Primier Arrivé 
 =>
 SI il sont execo il Faut Plusieur "PREMIER"s (TABLE) pour une COMPETITION Donnée
 SI il ne peut y avoir qu'un Seul Premier Il Faut Ajouter une 
    Contrainte d'Integrité Statique d'UNICITÉ SUR l'ensemble 
	(nbat , ncomp , score) Pour assurer qu'1 Score est 
	celui d'1 seul Bateu dans une Competition donné 
*/
